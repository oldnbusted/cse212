...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Assert.AreEqual failed. Expected:<Bob>. Actual:<Sue>. Fixed PersonQueue.Enqueue: Passed.
    ...
    // Fixed PersonQueue.Enqueue: Assert.AreEqual failed. Expected:<Tim>. Actual:<Sue>. 
    // Fixed TakingTurnsQueue.GetNextPerson: Passed
